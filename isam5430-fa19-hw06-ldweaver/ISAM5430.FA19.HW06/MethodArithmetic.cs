...
namespace CSharp.Assignments
{
    ...
    {
        /// <summary>
        /// Write the expression-bodied method named Hypotenuse that calculates the length of the hypotenuse (double) of a right triangle when the length of the other two sides are given. The method 
        /// should take two 
        /// double argumetns and return the hypotenuse as a double. The hypotenuse can be calculates by Sqrt(a^2 + b^2) where Sqrt is the square root function and a^2 means a squared.
        ...
        {
            double hypotenuse = (double)Sqrt(a * a + b * b);
            return hypotenuse;
        }
        ...
        /// <summary>
        /// Create a function named RoundThreeAverages that takes three integers from the input. The app will return the rounded average of these integers using only integer operations (e.g. integer 
        /// division with / and modulus (the remainder operator) with %) to accomplish this, so do not use float, double, or decimal data types, functions, and operations.
        ...
        /// <param name="c"></param>
        /// <example>
        /// If your numbers are 1, 2, 4, the rounded average is 7/3 or 2. However, if your numbers are 1, 2, 5, the rounded average is 8/3 or 3. Likewise, if your numbers are -1, -2, -4, 
        /// the rounded average is -7/3 or -2; and if your numbers are -1, -2, -5, the rounded average is -8/3 or -3.
        /// </example>
        /// 

        public itn RoundThreeAverages(int a, int b, int c)
        {
            int average = (a + b + c) / 3;
            return average;
        }
        ...
        /// <summary>
        /// This method named DisplayBox will display (with Console.Write*) a solid rectangle of fillCharacter whose number of rows and number of columns are specified in the arguments as row and column, 
        /// respectively.
        ...
        public char DisplayBox(int row, int column, char fillCharacter)
        {
        ...
        public int DisplayDigits(int n)
        {
        ...
        /// <summary>
        /// Create an expression-bodied method named Power that takes a decimal number and an integer. It then computes a to the n power. Note that if n is 0, their power is 1. If n is a negative number,
        /// the result is 1 over the power with a positive value of n. Assume that a cannot be 0.
        ...
        /// <remarks>There are a few ways to write this method. The simplest way is to use a loop. The other way is to write in recursion. The third way is to use a smarter loop with bitwise operations. 
        /// Do not use built-in functions such as Math.Pow().</remarks>
        ...
        /// <summary>
        /// An integer number is said to be a perfect number if its factors, including 1 (but not the number itself), sum up to the number. For example, 6 is a perfect number, because 6 = 1+ 2 + 3. Write a 
        /// method named PerfectNumber that determines whether parameter value is a perfect number.
        ...
        /// <summary>
        /// Write a method named ReverseBits that takes an non-negative integer value and returns the string in ones and zeros with its bits reversed. Do not use any built-in function but bitwise shift. 
        /// Also, do not prepend the zeros to your bits. For example, a reverse bit for 8 is "1" because 8 representing 1000 in binary reverses to "0001", which is essentially "1".
        ...
        /// which is between 0% and 100%. In addition, this method also outputs the letter grade as the out letterGrade. 0-59: F (GPA=0), 60-63: D- (GPA=2/3), 64-66: D (GPA=1), 67-69: D+ (GPA=4/3), 
        /// 70-73: C- (GPA=5/3), 74-76: C (GPA=2), 77-79 C+ (GPA=7/3),  80-83: B- (GPA=8/3), 84-86: B (GPA=3), 87-89 B+ (GPA=10/3), 90-93: A- (GPA=11/3), 94-96: A (GPA=4).
